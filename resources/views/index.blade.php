      ...
      <div class="row no-gutters">
       @foreach($descPosts as $descPost)
        <div class="col-12 col-lg-6">
          <div class="post-classic-tib big-post" style="background-image: url('posts/{{$descPost->image}}')">
        ...
        <div class="col-12 col-lg-6">
          <div class="row no-gutters">
            ...
            <div class="col-12 col-sm-6 col-lg-6">
              <div class="post-classic-tib mini-post" style="background-image: url('posts/{{$ascPost->image}}')">
                <div class="post-detail">
                  <div class="post-credit">
            ...
            <div class="col-lg-12">
              <div class="post-classic-tib mini-post" style="background-image: url('posts/{{$post->image}}')">
                <div class="post-detail">
                  <div class="post-credit">
      ...
      @foreach($row as $post)
        <div class="col-12 col-md-6">
          <div class="post-block post-classic">
            <div class="post-img"><img src="posts/{{$post->image}}" alt="post image"></div>
    ...
    <div class="blog-news_bundle recent-view-bundle">
      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-lg-4">
          <div class="post-mini_block"><img src="posts/{{$post->image}}" alt="post image">
            <div class="post-detail">
              <div class="post-credit">
                <div class="post-tag"><a href="#">{{$post->category->name}}</a></div>
  ...
  <div class="container">
    ...
    <div class="instagram-posts">
      ...
      <a class="instagram-img_block" href="/posts/{{$post->uuid}}">
        <img src="posts/{{$post->image}}" alt="instagram post">
